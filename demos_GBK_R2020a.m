...
triggerSigStandArray = exchangRowNM(triggerSiginstrumentsArray,triggerSigStandInitArray);
...
modalSelectorSigStandArray = exchangRowNM(modalSelectorSiginstrumentsArray,modalSelectorSigStandInitArray);
